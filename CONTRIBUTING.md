...
- Generated docs must build: `cargo doc --workspace --no-deps` 0 warnings, `cargo test --doc --workspace` passes.
...
| `test` | `cargo test --workspace` | pass, 45/45 `all_fixtures` |
| `doc` | `cargo test --doc --workspace` + `cargo doc --workspace --no-deps` | pass, 0 warnings |
