...
//! lowers each `Apply` to an [`Op::CallBuiltin`](crate::ir::Op::CallBuiltin) with a
...
/// date helpers that need symbol maps), which the VM maps to [`Value::Missing`](crate::base::Value::Missing).
///
...
///
/// ```
/// use pmmlruntime::engine::transform::builtin::eval_builtin;
/// use pmmlruntime::ir::BuiltinId;
///
...
///
/// ```
/// use pmmlruntime::engine::transform::builtin::eval_string_builtin;
/// use pmmlruntime::ir::BuiltinId;
///
