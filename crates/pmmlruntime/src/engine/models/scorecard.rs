...
use crate::ir::{PredicateIr, ScorecardIr, SimpleOperator};
...
/// [`crate::engine::predicate::eval_predicate`]). When none matches, `baselineScore` is added.
...
/// - `values`: Dense `&[Value]` indexed by [`FieldId`](crate::base::FieldId). Out-of-bounds fields are treated as `Missing`.
///
/// # Returns
///
...
/// use pmmlruntime::ir::*;
/// use pmmlruntime::engine::models::evaluate_scorecard;
///
        ...
        PredicateIr::Simple {
            ...
            match operator {
                ...
                _ => {
                    ...
                    match (actual, value) {
                        (Value::Continuous(a), crate::ir::SymbolIdOrContinuous::Continuous(b)) => {
                            match operator {
                        ...
                        (Value::Discrete(sid), crate::ir::SymbolIdOrContinuous::Symbol(s)) => {
                            match operator {
        ...
        PredicateIr::SimpleSet {
            ...
            for v in array {
                let matches = match (actual, v) {
                    (Value::Discrete(sid), crate::ir::SymbolIdOrContinuous::Symbol(s)) => sid == *s,
                    (Value::Continuous(a), crate::ir::SymbolIdOrContinuous::Continuous(b)) => {
                        (a - b).abs() < 1e-9
                    }
                    _ => false,
