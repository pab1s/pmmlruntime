...
/// use pmmlruntime::ir::*;
/// use pmmlruntime::engine::models::evaluate_naive_bayes;
///
/// let f = FieldId(0);
/// let s_a = SymbolId(1);
/// let s_b = SymbolId(2);
...
pub fn evaluate_naive_bayes(nb: &NaiveBayesIr, values: &[Value]) -> Value {
    ...
    let mut log_probs: std::collections::HashMap<crate::base::SymbolId, f64> =
        std::collections::HashMap::new();
    let mut best_score = f64::NEG_INFINITY;
    let mut best_value: Option<crate::base::SymbolId> = None;
