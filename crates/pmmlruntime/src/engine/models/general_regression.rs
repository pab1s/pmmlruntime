...
use crate::ir::GeneralRegressionIr;
...
/// - `values`: Dense `&[Value]` indexed by [`FieldId`](crate::base::FieldId).
...
/// use pmmlruntime::ir::*;
/// use std::collections::HashMap;
/// use pmmlruntime::engine::models::general_regression::evaluate_general_regression;
///
/// let fid = FieldId(0);
...
/// use pmmlruntime::ir::*;
/// use std::collections::HashMap;
/// use pmmlruntime::engine::models::general_regression::evaluate_general_regression_with_probs;
///
/// let fid = FieldId(0);
/// let s_low = SymbolId(1);
/// let s_high = SymbolId(2);
...
pub fn evaluate_general_regression_with_probs(
    ...
    let mut param_to_ppcells: HashMap<String, Vec<&crate::ir::PPCellIr>> = HashMap::new();
    ...
    let get_fid =
        |pred_name: &str| -> Option<crate::base::FieldId> { name_to_id.get(pred_name).copied() };
    ...
    let mut target_etas: HashMap<Option<crate::base::SymbolId>, f64> = HashMap::new();
    ...
    let mut exp_etas: HashMap<Option<crate::base::SymbolId>, f64> = HashMap::new();
    let mut sum_exp = 0.0;
    ...
    let mut best_cat: Option<crate::base::SymbolId> = None;
