...
/// - `values`: Dense `&[Value]` indexed by [`FieldId`](crate::base::FieldId). Out-of-bounds → `Missing` → `0`.
///
/// # Returns
///
...
/// use pmmlruntime::ir::*;
/// use pmmlruntime::engine::models::evaluate_neural_network;
///
/// let f1 = FieldId(0);
/// let f2 = FieldId(1);
