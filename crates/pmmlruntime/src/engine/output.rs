...
///
/// ```
/// use pmmlruntime::base::{Value, ResultFeature, SymbolId};
/// use pmmlruntime::ir::{OutputFieldIr, RankBasis, RankOrder};
/// use pmmlruntime::engine::output::build_output;
/// use std::collections::HashMap;
///
...
/// - `values`: Dense `&[Value]` indexed by [`crate::base::FieldId`]; used with `target_field` for `residual`.
...
///
/// ```
/// use pmmlruntime::base::{Value, SymbolId, FieldId, ResultFeature};
/// use pmmlruntime::ir::{OutputFieldIr, RankBasis, RankOrder};
/// use pmmlruntime::engine::output::build_output_with_context;
/// use std::collections::HashMap;
///
/// let sid = SymbolId(1);
/// let fields = vec![OutputFieldIr {
...
pub fn build_output_with_context(
    ...
    values: &[Value],
    target_field: Option<crate::base::FieldId>,
...
/// returns `Err(crate::base::error::PmmlError::UnsupportedMarkup)` instead of producing `Missing`.
///
/// # Parameters
///
...
/// # Errors
///
/// [`crate::base::error::PmmlError::UnsupportedMarkup`] when an output field's
...
///
/// ```
/// use pmmlruntime::base::{Value, ResultFeature};
/// use pmmlruntime::ir::{OutputFieldIr, RankBasis, RankOrder};
/// use pmmlruntime::engine::output::build_output_strict;
/// use std::collections::HashMap;
///
/// let fields = vec![OutputFieldIr {
///     name: "out".into(),
...
pub fn build_output_strict(
    ...
    predicted: Value,
    probabilities: &HashMap<String, f64>,
) -> Result<HashMap<String, Value>, crate::base::error::PmmlError> {
    for of in output_fields {
        if of.feature.is_unsupported() {
            return Err(crate::base::error::PmmlError::UnsupportedMarkup(format!(
...
mod tests {
    ...
    use crate::ir::{RankBasis, RankOrder};
