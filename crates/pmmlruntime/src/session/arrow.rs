...
///
/// ```
/// use pmmlruntime::session::arrow::ir_to_arrow_schema;
/// use pmmlruntime::base::{FieldId, field::{DataType, OpType}};
/// use pmmlruntime::ir::{FieldMeta, Ir, ModelIr, TreeIr, MiningSchemaIr, MissingValueStrategy, NoTrueChildStrategy};
/// use std::collections::HashMap;
/// let ir = Ir {
...
///
/// ```
/// use pmmlruntime::session::arrow::data_dictionary_to_schema;
/// use pmmlruntime::base::{FieldId, field::{DataType, OpType}};
/// use pmmlruntime::ir::FieldMeta;
/// let fields = vec![
    ...
    let fields: Vec<ArrowField> = data_dictionary
        ...
        .map(|fm| {
            let arrow_type = match fm.data_type {
                crate::base::field::DataType::Double
                | crate::base::field::DataType::Float
                | crate::base::field::DataType::Integer => ArrowDataType::Float64,
                crate::base::field::DataType::String => ArrowDataType::Utf8,
                crate::base::field::DataType::Boolean => ArrowDataType::Utf8, // keep as string for "true"/"false"
...
///
/// ```
/// use pmmlruntime::session::arrow::{value_maps_to_record_batch, data_dictionary_to_schema};
/// use pmmlruntime::base::{Value, FieldId, field::{DataType, OpType}};
/// use pmmlruntime::ir::FieldMeta;
/// use std::collections::HashMap;
/// use std::sync::Arc;
...
pub fn value_maps_to_record_batch(
    ...
    schema: Arc<Schema>,
    symbol_names: Option<&HashMap<crate::base::SymbolId, String>>,
...
///
/// ```
/// use pmmlruntime::session::arrow::{record_batch_to_value_maps, value_maps_to_record_batch};
/// use arrow::datatypes::{Field as ArrowField, DataType as ArrowDataType, Schema};
...
///
/// ```
/// use pmmlruntime::session::arrow::{inline_table_to_record_batch, data_dictionary_to_schema};
/// use std::collections::HashMap;
/// use std::sync::Arc;
/// use arrow::datatypes::{Field as ArrowField, DataType as ArrowDataType, Schema};
...
mod tests {
    ...
    fn arrow_schema_from_ir() {
        ...
        let fields = vec![
            FieldMeta {
                field_id: crate::base::FieldId(0),
                name: "Petal.Length".to_string(),
                data_type: crate::base::field::DataType::Double,
                op_type: crate::base::field::OpType::Continuous,
                values: vec![],
                ..Default::default()
            },
            FieldMeta {
                field_id: crate::base::FieldId(1),
                name: "Species".to_string(),
                data_type: crate::base::field::DataType::String,
                op_type: crate::base::field::OpType::Categorical,
                values: vec![],
                ..Default::default()
            },
        ];
    ...
    fn arrow_value_maps_roundtrip() {
        ...
        m1.insert("b".to_string(), Value::Discrete(crate::base::SymbolId(42)));
        let maps = vec![m1];
