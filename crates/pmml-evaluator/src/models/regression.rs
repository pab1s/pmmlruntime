...
//! per [`RegressionTableIr`](pmml_ir::ir::RegressionTableIr), summed over numeric and
...
/// - `values`: Dense `&[Value]` indexed by [`FieldId`](pmml_core::FieldId). Out-of-bounds or `Missing` numeric fields are skipped.
///
/// # Returns
///
...
///
/// ```
/// use pmml_core::{FieldId, Value, SymbolId};
/// use pmml_ir::ir::*;
/// use pmml_evaluator::models::evaluate_regression;
///
/// let f = FieldId(0);
