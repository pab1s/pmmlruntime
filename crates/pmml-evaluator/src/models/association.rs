...
/// - `values`: Dense `&[Value]` indexed by [`FieldId`](pmml_core::FieldId). Only `active_fields[0]` is read; out-of-bounds → `Missing`.
///
/// # Returns
///
...
/// use pmml_ir::ir::*;
/// use pmml_evaluator::models::evaluate_association;
///
/// let fid = FieldId(0);
