...
//! evaluation in `transform::vm` uses [`pmml_ir::ir::DiscretizeBin`] directly.
//!
//! # What belongs here
//!
...
/// the VM layer then maps `idx` to the actual [`pmml_core::SymbolId`] (`bin_value`) or to
...
/// ```
/// use pmml_core::Value;
/// use pmml_evaluator::transform::discretize::eval_discretize;
///
