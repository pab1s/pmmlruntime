...
pub enum PmmlError {
    ...
    /// A value could not be coerced to the target [`DataType`](crate::field::DataType) / [`OpType`](crate::field::OpType).
...
///
/// ```
/// use pmml_core::{PmmlError, Result};
